...
// bottom Sheet on GoogleMapView
  ...
  Widget build(BuildContext context) {
    final travelProvider = Provider.of<TravelController>(context);
                          ...
                          Row(
                            ...
                            children: [
                              IconButton(
                                onPressed: () {
                                  final jsonData =
                                      travelProvider.travelList[index].toJson();
                                  TravelModel itemId =
...
//   CustomSliverList({Key? key, required this.offset}) : super(key: key);
//   final double offset;
//   // call phone
//   void callPhone(String phone) async {
//     final String url = 'tel:+${phone}';
